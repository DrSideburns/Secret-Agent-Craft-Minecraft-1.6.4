...
public class EntityNinjaDart extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityNinjaDart(World par1World)
    {
        super(par1World);
    ...
    public EntityNinjaDart(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityNinjaDart(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityNinjaDart(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    {
                    	if(!(movingobjectposition.entityHit instanceof EntityJungleNinja)) {
                        damagesource = MADamageSource.causeNinjaDartDamage(this, this);
                        ((EntityLivingBase) movingobjectposition.entityHit).addPotionEffect(new PotionEffect(Potion.poison.id, 250));
                    	}
                    ...
                    {
                    	if(!(movingobjectposition.entityHit instanceof EntityJungleNinja)) {
                        damagesource = MADamageSource.causeNinjaDartDamage(this, this.shootingEntity);
                        ((EntityLivingBase) movingobjectposition.entityHit).addPotionEffect(new PotionEffect(Potion.poison.id, 250));
                    	}
