...
public class EntityPoisonDart extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityPoisonDart(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityPoisonDart(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    if (this.shootingEntity == null)
                    {
                        ...
                        damagesource = MADamageSource.causePoisonDartDamage(this, this);
                    ...
                    {
                    	if(!(movingobjectposition.entityHit instanceof EntityPlayer)) {
                        damagesource = MADamageSource.causePoisonDartDamage(this, this.shootingEntity);
                        ((EntityLivingBase) movingobjectposition.entityHit).addPotionEffect(new PotionEffect(Potion.poison.id, 250));
                    	}
