...
public class EntityAgent extends EntityMob implements IRangedAttackMob {
	
	public EntityAgent(World par1World) {
		super(par1World);
	...
	public void applyEntityAttributes() {
		...
		this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(50.0F);
    ...
    {
		this.dropItem(secretAgentMod.bullet.itemID, 8);
    }
	...
	protected void dropRareDrop(int par1)
    {
            ...
            case 0:
            	this.dropItem(secretAgentMod.handGun.itemID, 1);
            	break;
            }
    }
	 ...
	 public void attackEntityWithRangedAttack(EntityLivingBase par1EntityLivingBase, float par2)
	    {
			 	EntityBullet entitybullet = new EntityBullet(this.worldObj, this, 1.6F);
